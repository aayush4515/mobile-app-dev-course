...
public partial class MainPage : ContentPage
{
    ...
    private async void OnAboutClicked(System.Object sender, System.EventArgs e)
    {
        await Shell.Current.GoToAsync("//AboutPage");
    }

    private async void OnBreakfastClicked(System.Object sender, System.EventArgs e)
    {
        await Shell.Current.GoToAsync("//BreakfastPage");
    }

    private async void OnLunchClicked(System.Object sender, System.EventArgs e)
    {
        await Shell.Current.GoToAsync("//LunchPage");
    }

    private async void OnDinnerClicked(System.Object sender, System.EventArgs e)
    {
        await Shell.Current.GoToAsync("//DinnerPage");
    }

    private async void OnSnacksClicked(System.Object sender, System.EventArgs e)
    {
        await Shell.Current.GoToAsync("//SnacksPage");
    }

    async void OnImageTapped(System.Object sender, System.EventArgs e)
    {
